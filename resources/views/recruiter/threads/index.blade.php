...
.unread{
    background-color: #ff8b0042 !important;
}
</style>
@endpush
@section('content')
                ...
                <div class="ls-widget">
                    <div class="upper-title-box d-flex justify-content-between align-items-center p-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <a href="{{route('recruiter.mails.create')}}" class="btn-style-one bg-btn px-2"
                                id="add-message-btn">+ Nouveau message</a>
                        </div>
                    </div>
                    <div class="tabs-box">
                        <!-- TABLE AND GRID VIEW -->
                        <div class="widget-content">
                            ...
                            <div class="table-outer">
                                ...
                                <div class="col-12">
                                    <button class="bg-btn-four my-2 d-none" id="destroy-all-btn">Supprimer
                                ...
                                <div id="tabs-container">
                                    <div class="inbox table-container" id="inbox-container">
                                        <table class="table table-sm table-bordered" id="data-table-inbox">
                                            ...
                                            <tbody>
                                                @foreach ($receivedThreads as $thread)
                                                <tr class="@if(threadHasUnreadEmail($thread)) unread @else read @endif">
                                                    ...
                                                    <td>
                                                        <a href="{{route('recruiter.mails.show', $thread->id)}}">
                                                            Voir
                                                        </a>
                                                    </td>
                                                </tr>
                                    ...
                                    <div class="draft table-container" style="display: none" id="draft-container">
                                        <table class="table table-sm table-bordered" id="data-table-draft">
                                            ...
                                            <tbody>
                                                @foreach ($draftThreads as $thread)
                                                <tr>
                                                    <td>
                                                        {{ $thread->user->name }}
                                                    </td>
...
$(document).ready(function() {
    ...
    $('#data-table-inbox_filter input').before(
    ...
    $('#data-table-sent_filter input').before(
        '<i class="las la-search" style="padding: 10px; min-width: 40px; position: absolute;"></i>');
    ...
    $('#data-table-deleted_filter input').before(
        '<i class="las la-search" style="padding: 10px; min-width: 40px; position: absolute;"></i>');
    ...
    $('#data-table-draft_filter input').before(
        '<i class="las la-search" style="padding: 10px; min-width: 40px; position: absolute;"></i>');
        ...
        checkbox.addEventListener('change', function() {
            ...
            tableContainers.forEach(function(container) {
                if (container !== currentTableContainer) {
                    container.querySelectorAll('.checkbox-item:checked').forEach(
                        function(checkbox) {
