                ...
                <div class="ls-widget pt-5">
                    <div class="tabs-box">
                        <div class="widget-content">
                            <form action="{{route('recruiter.mails.store')}}" method="POST" id="message-form">
                                @csrf
...
$(document).ready(function() {
    ...
    document.getElementById("save-email-draft").addEventListener("click", function() {
        document.getElementById("message-form").action = "{{ route('recruiter.mails.store.draft') }}"; // Replace with the actual route for saving drafts
