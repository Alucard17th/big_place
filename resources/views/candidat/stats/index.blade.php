...
<div class="user-dashboard bc-user-dashboard">
    <div class="dashboard-outer">
        <div class="row">
            <div class="col-lg-12">
                <!-- Ls widget -->
                <div class="ls-widget" style="background: none;">
                        ...
                        <div class="widget-content">
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-3">
                                    <div class="card stat-card">
                                        <div class="card-body">
                                            <h5 class="card-title">Réponse aux candidatures envoyées</h5>
                                ...
                                <div class="col-3 mt-3">
                                    <div class="card stat-card">
                                        <div class="card-body">
                                            <h5 class="card-title">Candidature refusées</h5>
