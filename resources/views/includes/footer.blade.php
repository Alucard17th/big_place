            ...
            <div class="row">
                <div class="big-column col-xl-4 col-lg-3 col-md-12">
                    <div class="footer-column about-widget">
                        ...
                        <p class="phone-num"><span>Contactez-nous</span><a href="tel:+33612378777"> Tél. : 06 12
                                37 87 77</a></p>
                        <p class="address">8 bis rue Abel, 75012 Paris<br>
                            <a href="mailto:contact@bigplace.fr" class="email"> Email : contact@bigplace.fr</a>
                        </p>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="footer-column col-lg-3 col-md-6 col-sm-12">
                            <div class="footer-widget links-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="list">
                                        <li><a href="https://bigplace.fr/page/a-propos">Notre mission</a></li>
                            ...
                            <div class="footer-widget links-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="list">
                                        ...
                                        <li><a href="https://bigplace.fr/page/parrainage">Parrainage</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="footer-column col-lg-3 col-md-6 col-sm-12">
                            <div class="footer-widget links-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="list">
                                        <li><a href="https://bigplace.fr/register-candidat">Inscription</a></li>
                                        <li><a href="https://bigplace.fr/login">Connexion</a></li>
                            ...
                            <div class="footer-widget links-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="list">
                                        ...
                                        <li><a href="https://bigplace.fr/page/support-client">Support client</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <div class="newsletter-form wow fadeInUp style-eight animated"
        ...
        <div class="auto-container">
            <div class="sec-title text-center">
                ...
                <div class="text">Recevez toutes les actualités du monde de l'emploi<br> et restez informé(e)s
                </div>
            </div>
        ...
        <div class="auto-container">
            <div class="outer-box">
                ...
                <div class="copyright-text">
                    <h5>© 2023 <a href="/public/page/termes-and-conditions">BigPlace</a>. Tous droits réservés
                    </h5>
                </div>
