<div class="user-sidebar">
    <div class="sidebar-inner">
        <ul class="navigation">
            <li class="active">
                <a href="https://bigplace.fr/user/dashboard" class="d-flex justify-content-between align-items-center">
                    <span class="d-flex align-items-center"><i class="la la-home"></i> Tableau de bord (candidat)</span>
                </a>
            </li>
            <li class="">
                <a href="https://bigplace.fr/user/my-contact" class="d-flex justify-content-between align-items-center">
            ...
            <li class="">
                <a href="https://bigplace.fr/user/my-contact" class="d-flex justify-content-between align-items-center">
                    <span class="d-flex align-items-center"><i class="la la-envelope"></i> Mes formations
                        proposées</span>
                </a>
            </li>
            <li class="">
            ...
            <li class="">
                <a href="https://bigplace.fr/user/my-contact" class="d-flex justify-content-between align-items-center">
                    <span class="d-flex align-items-center"><i class="la la-envelope"></i> Mes factures et
                        contrats</span>
                </a>
            </li>
            <li class="">
            ...
            <li class="">
                <a href="https://bigplace.fr/user/my-contact" class="d-flex justify-content-between align-items-center">
                    <span class="d-flex align-items-center"><i class="la la-envelope"></i> Mon compte
                        administrateur</span>
                </a>
            </li>
            <li class="">
                <a href="https://bigplace.fr/user/profile/change-password"
